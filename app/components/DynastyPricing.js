...
export default function DynastyPricing() {
  const plans = [
    ...
    },
    {
      ...
      setupPrice: 75000,
      originalSetupPrice: 90000,
      monthlyMaintenance: 3999,
  ...
  return (
    <section id="dynasty-pricing" className="py-20 bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div data-aos="fade-up" className="text-center mb-16">
          <span className="inline-flex items-center space-x-2 bg-blue-500/15 text-blue-200 border border-blue-400/20 px-4 py-2 rounded-full mb-4">
          ...
          <p className="text-xl text-slate-300 max-w-3xl mx-auto">
            <strong className="text-blue-300">DYNASTY PORT</strong> ile tek seferlik kurulum bedeli + aylık bakım ücreti ile 
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {plans.map((plan, index) => (
            <div
              ...
              className={`relative bg-slate-950/55 backdrop-blur-sm rounded-2xl shadow-xl overflow-hidden transform hover:scale-105 transition-all duration-300 border border-white/10 ${
                plan.popular ? 'ring-2 ring-purple-400/60' : ''
              }`}
            >
              {/* Popular Badge */}
              {plan.popular && (
              ...
              <div className="p-8">
                ...
                <div className="mb-6">
                  ...
                  {/* Discount Badge */}
                  <div className="inline-block bg-green-500/15 text-green-200 border border-green-400/20 px-3 py-1 rounded-full text-sm font-semibold mb-3">
                    {((1 - plan.setupPrice / plan.originalSetupPrice) * 100).toFixed(0)}% İndirim
                  </div>

                  {/* Monthly Maintenance */}
                  <div className="mt-4 p-2 lg:p-4 bg-blue-500/10 border border-blue-400/15 rounded-lg">
                    <div className="flex items-center justify-between">
                      <div className="text-left">
                        <div className="text-sm lg:text-base font-bold text-blue-200">
                          Website + ERP
                        </div>
                      </div>
                      <div className="text-right">
                        <div className="flex items-baseline justify-end">
                          <span className="lg:text-2xl font-bold text-blue-200">
