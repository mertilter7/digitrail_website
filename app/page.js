...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 text-slate-100">
      {/* Navigation */}
      <nav className={mobileMenuOpen ? " border-b bg-[#03081B] border-white/10 sticky top-0 z-[100] shadow-sm" : "bg-[#03081B] border-b border-white/10 sticky top-0 z-[100] shadow-sm"}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8"> 
          <div className="flex justify-between items-center ">
            ...
            <div className="hidden lg:flex lg:items-center space-x-8">
              <a href="#home" className="text-slate-200 hover:text-pink-400 hover:scale-105 transition-all duration-200 font-medium">Ana Sayfa</a>
              <a href="#solutions" className="text-slate-200 hover:text-blue-400 hover:scale-105 transition-all duration-200 font-medium">Hizmetler</a>
              <a href="#projects" className="text-slate-200 hover:text-purple-400 hover:scale-105 transition-all duration-200 font-medium">Projelerimiz</a>
              <a href="#dynasty-pricing" className="text-slate-200 hover:text-green-400 hover:scale-105 transition-all duration-200 font-medium">Fiyatlandırma</a>
              <a href="#partnership" className="text-slate-200 hover:text-indigo-400 hover:scale-105 transition-all duration-200 font-medium">Ortaklık</a>
              <a href="#about" className="text-slate-200 hover:text-pink-400 hover:scale-105 transition-all duration-200 font-medium">Hakkımızda</a>
          ...
          {mobileMenuOpen && (
            <>
              ...
              <div className="fixed top-16 left-0 right-0 lg:hidden z-[90] animate-slide-down">
                <div className=" bg-[#03081B] shadow-2xl rounded-b-3xl min-h-screen overflow-hidden border-b border-white/10">
                  <div className="px-4 pt-10 pb-6 space-y-2 overflow-y-auto">
                    <a 
                      href="#home" 
                      onClick={() => setMobileMenuOpen(false)}
                      className="animate-menu-item flex items-center space-x-4 px-4 py-4 text-slate-200 hover:bg-white/5 hover:text-pink-300 rounded-xl transition-all duration-300 font-medium group"
                    >
                      <div className="w-10 h-10 flex items-center justify-center bg-pink-500/15 group-hover:bg-pink-600 rounded-lg transition-colors duration-300">
                        <svg className="w-5 h-5 text-pink-300 group-hover:text-white transition-colors duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6" />
                        </svg>
                      </div>
                      <span className="flex-1">Ana Sayfa</span>
                      <svg className="w-5 h-5 text-slate-400 group-hover:text-pink-300 group-hover:translate-x-1 transition-all duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <a 
                      href="#solutions" 
                      onClick={() => setMobileMenuOpen(false)}
                      className="animate-menu-item flex items-center space-x-4 px-4 py-4 text-slate-200 hover:bg-white/5 hover:text-blue-300 rounded-xl transition-all duration-300 font-medium group"
                    >
                      <div className="w-10 h-10 flex items-center justify-center bg-blue-500/15 group-hover:bg-blue-600 rounded-lg transition-colors duration-300">
                        <svg className="w-5 h-5 text-blue-300 group-hover:text-white transition-colors duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M10 20l4-16m4 4l4 4-4 4M6 16l-4-4 4-4" />
                        </svg>
                      </div>
                      <span className="flex-1">Hizmetler</span>
                      <svg className="w-5 h-5 text-slate-400 group-hover:text-blue-300 group-hover:translate-x-1 transition-all duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                      </svg>
                    </a>
                    ...
                    <a 
                      href="#projects" 
                      onClick={() => setMobileMenuOpen(false)}
                      className="animate-menu-item flex items-center space-x-4 px-4 py-4 text-slate-200 hover:bg-white/5 hover:text-purple-300 rounded-xl transition-all duration-300 font-medium group"
                    >
                      <div className="w-10 h-10 flex items-center justify-center bg-purple-500/15 group-hover:bg-purple-600 rounded-lg transition-colors duration-300">
                      ...
                      <svg className="w-5 h-5 text-slate-400 group-hover:text-purple-300 group-hover:translate-x-1 transition-all duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                      </svg>
                    </a>
                    ...
                    <a 
                      ...
                      onClick={() => setMobileMenuOpen(false)}
                      className="animate-menu-item flex items-center space-x-4 px-4 py-4 text-slate-200 hover:bg-white/5 hover:text-green-300 rounded-xl transition-all duration-300 font-medium group"
                    >
                      <div className="w-10 h-10 flex items-center justify-center bg-green-500/15 group-hover:bg-green-600 rounded-lg transition-colors duration-300">
                        <svg className="w-5 h-5 text-green-300 group-hover:text-white transition-colors duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                        </svg>
                      </div>
                      <span className="flex-1">Fiyatlandırma</span>
                      <svg className="w-5 h-5 text-slate-400 group-hover:text-green-300 group-hover:translate-x-1 transition-all duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                      </svg>
                    </a>
                    ...
                    <a 
                      href="#partnership" 
                      onClick={() => setMobileMenuOpen(false)}
                      className="animate-menu-item flex items-center space-x-4 px-4 py-4 text-slate-200 hover:bg-white/5 hover:text-indigo-300 rounded-xl transition-all duration-300 font-medium group"
                    >
                      <div className="w-10 h-10 flex items-center justify-center bg-indigo-500/15 group-hover:bg-indigo-600 rounded-lg transition-colors duration-300">
                      ...
                      <svg className="w-5 h-5 text-slate-400 group-hover:text-indigo-300 group-hover:translate-x-1 transition-all duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                      </svg>
                    </a>
      ...
      <section id="home" className="py-8 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
        ...
        <div className="absolute top-0 left-0 w-72 h-72 bg-gradient-to-r from-pink-400 to-purple-400 rounded-full mix-blend-screen filter blur-2xl opacity-10 md:opacity-25 animate-blob"></div>
        <div className="absolute bottom-20 right-20 w-72 h-72 bg-gradient-to-r from-amber-400 to-orange-400 rounded-full mix-blend-screen filter blur-2xl opacity-10 md:opacity-25 animate-blob animation-delay-2000"></div>
       
        <div className="absolute top-0 right-0 w-72 h-72 bg-gradient-to-r from-blue-400 to-cyan-400 rounded-full mix-blend-screen filter blur-2xl opacity-10 md:opacity-25 animate-blob animation-delay-2000"></div>
        <div className="absolute -bottom-8 left-20 w-72 h-72 bg-gradient-to-r from-purple-400 to-pink-400 rounded-full mix-blend-screen filter blur-2xl opacity-10 md:opacity-25 animate-blob animation-delay-4000"></div>
        
        <div className="max-w-7xl mx-auto text-center relative z-10">
          {/* Badge */}
          <div data-aos="zoom-in" className="inline-flex items-center px-4 sm:px-6 py-2 sm:py-3 bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded-full text-xs sm:text-sm font-medium mb-6 sm:mb-8 shadow-lg">
            <div className="w-2 h-2 bg-white rounded-full mr-2 animate-pulse"></div>
            Dijital Dönüşüm Uzmanları
          </div>
          
          {/* Main Heading */}
          <h1 data-aos="fade-up" className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl font-bold text-white mb-6 sm:mb-8 leading-tight px-4">
            Dijital Dünyada
          ...
          {/* Subtitle */}
          <p data-aos="fade-up" data-aos-delay="120" className="text-lg sm:text-xl md:text-2xl text-slate-300 mb-8 sm:mb-12 max-w-4xl mx-auto leading-relaxed px-4">
            Modern web teknolojileri ile işinizi dijital dünyaya taşıyoruz. 
            <span className="font-semibold text-slate-200"> Profesyonel web siteleri</span>, 
            <span className="font-semibold text-slate-200"> Özel yazılım çözümleri</span> ve 
            <span className="font-semibold text-slate-200"> dijital pazarlama stratejileri</span> ile 
            markanızı büyütün.
          </p>
          
          {/* CTA Buttons */}
          <div data-aos="fade-up" data-aos-delay="200" className="flex flex-col sm:flex-row gap-4 sm:gap-6 justify-center mb-16 px-4">
            <button 
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 max-w-4xl mx-auto">
            <div data-aos="fade-up" data-aos-delay="120" className="text-center">
              <div className="w-16 h-16 bg-gradient-to-r from-green-500 to-emerald-500 rounded-2xl flex items-center justify-center mx-auto mb-4 shadow-lg">
                <svg className="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                </svg>
              </div>
              <h3 className="text-lg font-semibold text-white mb-2">7+ Yıl Deneyim</h3>
              <p className="text-slate-300 text-sm">Sektörde kanıtlanmış uzmanlık</p>
            </div>
            <div data-aos="fade-up" data-aos-delay="180" className="text-center">
              ...
              <p className="text-slate-300 text-sm">Zamanında proje tamamlama</p>
            </div>
            <div data-aos="fade-up" data-aos-delay="240" className="text-center">
              ...
              <p className="text-slate-300 text-sm">Kesintisiz teknik destek</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <footer className="relative bg-gradient-to-br from-gray-900 via-blue-900 to-purple-900 text-white py-16 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="grid grid-cols-12 md:grid-cols-2 lg:grid-cols-4 lg:gap-12  mb-12">
            {/* Company Info */}
            <div className="col-span-12 lg:col-span-1">
              <div className="flex items-center mb-4">
                <Image 
                  ...
                  className="mr-3 rounded-lg"
                />
                <h3 className="text-2xl font-bold bg-gradient-to-r from-blue-400 to-purple-400 bg-clip-text text-transparent hidden">Digitrail</h3>
              </div>
            ...
            {/* Services */}
            <div className='mt-6 col-span-6 lg:col-span-1'>
            ...
            {/* Our Projects */}
            <div className='mt-6 col-span-12 lg:col-span-1'>
              <h4 className="text-xl font-bold mb-6 bg-gradient-to-r from-amber-400 to-orange-400 bg-clip-text text-transparent">Sosyal Medya</h4>
